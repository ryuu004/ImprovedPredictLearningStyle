...
from backend.routers import model_metrics # Import the new router
...
async def train_model():
    ...
    print(f"Confusion matrices after training: {confusion_matrices}") # Debug print
...
app.include_router(model_metrics.router) # Include the new router
